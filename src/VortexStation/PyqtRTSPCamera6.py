...
class PyqtRTSPCamera6(CameraManager, QThread):
    RTSPCamera6FrameEvent = pyqtSignal(object)
    ...
    def run(self):
        ...
        """
        while self.running:
            # print("RTSPCAMERA6 FRAME Thread")
            ...
            if frame is not None:
                self.RTSPCamera6FrameEvent.emit(frame)  # Emit frame to main thread for display
                # print("RTSPCAMERA6 FRAME EMITTED")
