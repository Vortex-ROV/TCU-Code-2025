...
class PyqtController(QObject):
    ...
    def __init__(self, controller: ControllerInterfaces):
        super().__init__()
    ...
    def getData(self):
        controllerData = self.controller.getControllerData()
        # self.handle_events(controllerData)
