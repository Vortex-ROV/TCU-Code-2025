...
class PyqtRTSPCamera2(CameraManager, QThread):
    RTSPCamera2FrameEvent = pyqtSignal(object)
    ...
    def run(self):
        ...
        """
        while self.running:
            # print("RTSPCAMERA2 FRAME Thread")
            ...
            if frame is not None:
                self.RTSPCamera2FrameEvent.emit(frame)  # Emit frame to main thread for display
                # print("RTSPCAMERA2 FRAME EMITTED")
