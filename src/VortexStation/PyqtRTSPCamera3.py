...
class PyqtRTSPCamera3(CameraManager, QThread):
    RTSPCamera3FrameEvent = pyqtSignal(object)
    ...
    def run(self):
        ...
        """
        while self.running:
            # print("RTSPCAMERA3 FRAME Thread")
            ...
            if frame is not None:
                self.RTSPCamera3FrameEvent.emit(frame)  # Emit frame to main thread for display
                # print("RTSPCAMERA3 FRAME EMITTED")
