...
class PyqtRTSPCamera8(CameraManager, QThread):
    RTSPCamera8FrameEvent = pyqtSignal(object)
    ...
    def run(self):
        ...
        """
        while self.running:
            # print("RTSPCAMERA8 FRAME Thread")
            ...
            if frame is not None:
                self.RTSPCamera8FrameEvent.emit(frame)  # Emit frame to main thread for display
                # print("RTSPCAMERA8 FRAME EMITTED")
