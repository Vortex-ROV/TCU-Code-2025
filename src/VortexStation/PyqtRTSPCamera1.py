...
class PyqtRTSPCamera1(CameraManager, QThread):
    RTSPCamera1FrameEvent = pyqtSignal(object)
    ...
    def run(self):
        ...
        """
        while self.running:
            # print("RTSPCAMERA1 FRAME Thread")
            ...
            if frame is not None:
                self.RTSPCamera1FrameEvent.emit(frame)  # Emit frame to main thread for display
                # print("RTSPCAMERA1 FRAME EMITTED")
