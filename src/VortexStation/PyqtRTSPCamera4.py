...
class PyqtRTSPCamera4(CameraManager, QThread):
    RTSPCamera4FrameEvent = pyqtSignal(object)
    ...
    def run(self):
        ...
        """
        while self.running:
            # print("RTSPCAMERA4 FRAME Thread")
            ...
            if frame is not None:
                self.RTSPCamera4FrameEvent.emit(frame)  # Emit frame to main thread for display
                # print("RTSPCAMERA4 FRAME EMITTED")
