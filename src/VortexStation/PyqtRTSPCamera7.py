...
class PyqtRTSPCamera7(CameraManager, QThread):
    RTSPCamera7FrameEvent = pyqtSignal(object)
    ...
    def run(self):
        ...
        """
        while self.running:
            # print("RTSPCAMERA7 FRAME Thread")
            ...
            if frame is not None:
                self.RTSPCamera7FrameEvent.emit(frame)  # Emit frame to main thread for display
                # print("RTSPCAMERA7 FRAME EMITTED")
